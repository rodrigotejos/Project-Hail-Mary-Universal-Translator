"""
Script to list all registered vocabulary from the database.
"""
import os
import sys
...
from database.registry import TranslatorDB  # pylint: disable=wrong-import-position

def main():
    """Main execution function to list vocabulary."""
    db = TranslatorDB()
