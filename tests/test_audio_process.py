...
from src.engine.audio_process import AudioProcessor  # pylint: disable=wrong-import-position

@pytest.fixture
def audio_processor():
    """Fixture providing an instance of AudioProcessor."""
...
def test_extract_features(mock_mfcc, audio_processor):
    ...
    assert features.shape == (1024,)  # Updated based on the real implementation
