...
class VectorDB:
    ...
    def add_audio_signature(self, word: str, language: str, embedding: List[float], audio_path: str):
        """
    ...
    def search_similar_audio(self, query_embedding: List[float], language: str, threshold: float = 0.8) -> Optional[Dict[str, Any]]:
        """
