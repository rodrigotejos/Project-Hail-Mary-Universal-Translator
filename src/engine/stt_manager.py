"""
STT Manager module for converting speech to text using Whisper.
"""
import os
import numpy as np
import librosa
...
class STTManager:
    """Manager for Speech-to-Text operations using Whisper."""
    ...
    def transcribe_file(self, filepath: str, language: str = "pt") -> str:
        ...
        try:
            # Load audio file
            audio, _sr = librosa.load(filepath, sr=16000)  # Whisper expects 16kHz
