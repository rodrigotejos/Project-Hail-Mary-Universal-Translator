...
def create_main_layout():
    ...
    left_content = ft.Column([
        ...
        ft.Row([ft.Icon(ft.Icons.MIC, color=THEME["accent_color"]), ft.Text("(Falar)"), ft.Icon(ft.Icons.CHECK_CIRCLE, color="green"), ft.Text("(Confirmar)")])
    ])
    ...
    right_content = ft.Column([
        ...
        ft.Row([ft.Icon(ft.Icons.MIC, color=THEME["accent_color"]), ft.Text("(Falar)"), ft.Icon(ft.Icons.SEND, color=THEME["accent_color"]), ft.Text("(Enviar)")])
    ])
